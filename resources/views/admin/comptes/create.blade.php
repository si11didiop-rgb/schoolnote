<x-app-layout>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                ...
                <div class="bg-indigo-600 px-6 py-4">
                    <h3 class="text-white font-bold text-lg">👤 Nouveau compte</h3>
                </div>

                <form action="{{ route('admin.comptes.store') }}" method="POST" class="p-6 space-y-5">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="role" name="role" required
                                ...
                                <option value="eleve" @selected(old('role') == 'eleve')>Élève</option>
                    ...
                    <div>
                        ...
                        <x-text-input id="password" name="password" type="password" class="mt-1 block w-full"
                                      required />
                        <p class="text-xs text-gray-400 mt-1">Min. 8 caractères — L'utilisateur devra le changer à sa première connexion.</p>
                        <x-input-error :messages="$errors->get('password')" class="mt-1" />
                    </div>

                    <!-- Champs Élève -->
                    <div id="champs-eleve" class="space-y-4 hidden">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="date_de_naissance" name="date_de_naissance" type="date"
                                                  class="mt-1 block w-full" :value="old('date_de_naissance')" />
                                ...
                                <div>
                                    ...
                                    <select id="statut" name="statut"
                                        ...
                                        <option value="suspendu" @selected(old('statut') == 'suspendu')>⏸️ Suspendu</option>
                                        <option value="diplome" @selected(old('statut') == 'diplome')>🎓 Diplômé</option>
                                    </select>
                                ...
                                <select id="classe_id" name="classe_id"
                                    ...
                                    @foreach ($classes as $classe)
                                        <option value="{{ $classe->id }}"
                                                @selected(old('classe_id') == $classe->id)>
                    ...
                    <!-- Champs Enseignant -->
                    <div id="champs-enseignant" class="hidden">
                        <div class="p-4 bg-green-50 border border-green-200 rounded-lg">
                            ...
                            <x-text-input id="specialite" name="specialite" type="text"
                                          class="mt-1 block w-full" :value="old('specialite')"
                    ...
                    <!-- Champs Parent -->
                    <div id="champs-parent" class="hidden">
                        <div class="p-4 bg-red-50 border border-red-200 rounded-lg">
                            ...
                            <x-text-input id="lien_parente" name="lien_parente" type="text"
                                          class="mt-1 block w-full" :value="old('lien_parente')"
    ...
    <script>
        ...
        // Afficher les champs si old() a une valeur
        document.addEventListener('DOMContentLoaded', function () {
            const role = document.getElementById('role').value;
            if (role) afficherChamps(role);
        });
    </script>
</x-app-layout>
