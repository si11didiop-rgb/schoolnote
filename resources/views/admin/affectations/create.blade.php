        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                ...
                <div class="bg-indigo-600 px-6 py-4">
                    ...
                    <p class="text-indigo-200 text-sm mt-1">Affecter un enseignant à une matière dans une classe</p>
                </div>

                <form action="{{ route('admin.affectations.store') }}" method="POST" class="p-6 space-y-5">
                    @csrf
