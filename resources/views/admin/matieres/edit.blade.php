        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <div class="bg-gradient-to-r from-yellow-400 to-yellow-500 px-6 py-4">
                    <h3 class="text-white font-bold text-lg">✏️ Modifier la matière</h3>
                    <p class="text-yellow-100 text-sm mt-1">{{ $matiere->nom }}</p>
                </div>
                    ...
                    <form action="{{ route('admin.matieres.update', $matiere) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nom" name="nom" class="block mt-1 w-full rounded-lg"
                                          type="text" :value="old('nom', $matiere->nom)" required autofocus />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="coefficient" name="coefficient" class="block mt-1 w-full rounded-lg"
                                          type="number" :value="old('coefficient', $matiere->coefficient)"
